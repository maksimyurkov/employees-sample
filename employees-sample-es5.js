...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__node_modules_core_js_fn_symbol_iterator_js__ = __webpack_require__(37);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__node_modules_core_js_fn_symbol_iterator_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__node_modules_core_js_fn_symbol_iterator_js__);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__node_modules_core_js_modules_es6_symbol_js__ = __webpack_require__(55);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__node_modules_core_js_modules_es6_symbol_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__node_modules_core_js_modules_es6_symbol_js__);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__node_modules_core_js_modules_es6_string_includes_js__ = __webpack_require__(62);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__node_modules_core_js_modules_es6_string_includes_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__node_modules_core_js_modules_es6_string_includes_js__);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_3__node_modules_whatwg_fetch_fetch_js__ = __webpack_require__(66);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_3__node_modules_whatwg_fetch_fetch_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__node_modules_whatwg_fetch_fetch_js__);
  ...
  var EmployeesSample = function (_HTMLElement) {
    _inherits(EmployeesSample, _HTMLElement);

    function EmployeesSample() {
      _classCallCheck(this, EmployeesSample);

      return _possibleConstructorReturn(this, (EmployeesSample.__proto__ || Object.getPrototypeOf(EmployeesSample)).apply(this, arguments));
    }

    _createClass(EmployeesSample, [{
      key: '_getEmployees',
      value: function _getEmployees() {
      ...
      value: function _filterEmployees() {
      ...
      key: '_updateList',
      value: function _updateList(filteredEmployees) {
        var list = this.shadowRoot.querySelector('#list');
        var scroller = this.shadowRoot.querySelector('#scroller');
        scroller.innerHTML = '';
        ...
        try {
          for (var _iterator2 = filteredEmployees[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var i = _step2.value;

            var tempTemplate = document.importNode(itemTemplate.content, true);
      ...
      value: function connectedCallback() {
        ...
        this.shadowRoot.querySelector('#search').addEventListener('keyup', function (e) {
          if (_this2.inputTimer !== undefined) clearTimeout(_this2.inputTimer);
          _this2.searchText = _this2.shadowRoot.querySelector('#search').value;
          _this2.shadowRoot.querySelector('#filter-employees').style.setProperty('display', 'flex', 'important');
          _this2.shadowRoot.querySelector('#nothing-found').style.setProperty('display', 'none', 'important');
          if (_this2.searchText !== undefined && _this2.searchText !== '' && _this2.searchText.length > 3) {
            _this2.shadowRoot.querySelector('#filter-employees').style.setProperty('display', 'flex', 'important');
            _this2.inputTimer = setTimeout(_this2._filterEmployees.bind(_this2), 800);
          } else {
            _this2.shadowRoot.querySelector('#nothing-found').style.setProperty('display', 'none', 'important');
            _this2._updateList([]);
            return;
        ...
        this._getEmployees().then(function (employees) {
          _this2.employees = employees;
          _this2.shadowRoot.querySelector('#loading-employees').style.setProperty('display', 'none', 'important');
        });
      }
    }], [{
      key: 'employees',
